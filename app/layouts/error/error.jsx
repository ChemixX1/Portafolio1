import notFoundPoster from '~/assets/error/not-found.jpg';
import notFoundVideo from '~/assets/error/not-found.mp4';
import flatlinePoster from '~/assets/error/flatline.png';
import flatlineVideo from '~/assets/error/flatline.mp4';
